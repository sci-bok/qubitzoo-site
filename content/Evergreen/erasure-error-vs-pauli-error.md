...
- [[threshold-theorem]] — the erasure channel's ~50% surface-code threshold is the most dramatic example of a noise-model-dependent threshold
- [[coherence-time-hierarchy]] — the dominant coherence process (e.g., $T_1$ decay converting to detectable leakage) determines whether erasure conversion is achievable at all
- [[decoherence-free-subspace]] — passive protection eliminates the need for detection; erasure conversion instead makes the dominant error detectable
