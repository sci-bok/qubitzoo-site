...
- [[coherence-time-hierarchy]] — hyperfine clock-state storage versus Rydberg gate timescales is the standard frame for judging idle fidelity against gate speed
- [[threshold-theorem]] — the surface-code and logical-qubit results on atom arrays are claims about operating below threshold, not just about raw gate fidelity
